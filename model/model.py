...
class SSD300(nn.Module):
	...
	def __init__(self, n_classes):
		...
		self.ft_3 = nn.Sequential(
			...
			F.interpolate(size=(38, 38), mode='bilinear')  
			)
	...
	def create_prior_boxes(self):
		...
		# aspect_ratios = {'conv4_3': [1., 3., .333],
		# 				 'conv7': [1.,  3., .333, 3., .333],
		# 				 'conv8_2': [1.,  3.,  .333, 3., .333],
		# 				 'conv9_2': [1.,  3.,  .333, 3., .333],
		# 				 'conv10_2': [1., 3., .333],
		# 				 'conv11_2': [1., 3., .333]}

		# aspect_ratios = {'conv4_3': [1., 2., 0.5],
		# 				 'conv7': [1., 2., 2., 0.5, 0.5],
		# 				 'conv8_2': [1., 2., 2., 0.5, 0.5],
		# 				 'conv9_2': [1., 2., 2., 0.5, 0.5],
		# 				 'conv10_2': [1., 2., 0.5],
		# 				 'conv11_2': [1., 2., 0.5]}
