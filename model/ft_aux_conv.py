...
class FtAuxiliaryConvolutions(nn.Module):
	...
	def __init__(self):
		...
		self.convf1 = nn.Sequential(
			nn.Conv2d(256 * 3, 512, kernel_size=1, padding=0),
			nn.ReLU(),
	...
	def forward(self, ft):
		...
		convft5_feats = self.convf5(output)
		

		# Higher-level feature maps
		return convft1_feats, convft2_feats, conv1ft3_feats, convft4_feats,convft5_feats