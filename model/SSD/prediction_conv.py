...
class PredictionConvolutions(nn.Module):
    ...
    def __init__(self, config):
        ...
        if(config.chanel_attention == 'SE'):
            ...
            if config.mode == BASIC:
                ...
                self.CA3 = SEBlock(512)
            else:
                self.CA2 = SEBlock(512)
                self.CA3 = SEBlock(256)
    ...
    def forward(self, conv4_3_feats, conv7_feats, conv8_2_feats, conv9_2_feats, conv10_2_feats, conv11_2_feats):
        ...
        if(self.need_attention!= 'None'):
            ...
            conv9_2_feats = self.CA4(conv9_2_feats)
            conv10_2_feats = self.CA5(conv10_2_feats)
            conv11_2_feats = self.CA6(conv11_2_feats)
